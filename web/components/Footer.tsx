      ...
      <div className="container relative">
        ...
        <div className="border-b border-white/10 pb-12 mb-12">
          <div className="grid lg:grid-cols-[1.6fr_1fr] gap-10 items-end">
            ...
            <p className="text-white/55 text-[17px] leading-relaxed max-w-[380px]">
              Gear up every season. Performance-driven workout wear engineered for every condition — built for summer heat and winter cold.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 pb-12 border-b border-white/10">
          <div className="col-span-2">
            <h5 className="text-[12px] uppercase tracking-[.2em] text-white/55 font-semibold mb-5">Flagship</h5>
          ...
          <FootCol title="Shop" links={[["/shop?category=Outerwear","Outerwear"],["/shop?category=Tops","Tops"],["/shop?category=Bottoms","Bottoms"],["/shop?category=Accessories","Accessories"]]}/>
          <FootCol title="Support" links={[["#","Contact"],["#","Shipping"],["#","Returns"],["#","Size guide"]]}/>
          <FootCol title="Brand" links={[["#","About"],["#","Athletes"],["#","Stores"],["#","Journal"]]}/>
        </div>

        <div className="flex flex-col sm:flex-row justify-between gap-4 pt-8 text-[13px] text-white/45">
          <div className="flex items-center gap-6">
            <span>© 2026 VEXO Athletic Inc.</span>
            <Link href="#" className="hover:text-white">Privacy</Link>
            <Link href="#" className="hover:text-white">Terms</Link>
            <Link href="#" className="hover:text-white">Accessibility</Link>
          </div>
          <span className="text-[13px] uppercase tracking-[.18em] text-white/55">Gear up · Every season</span>
        </div>
      </div>
    </footer>
  );
